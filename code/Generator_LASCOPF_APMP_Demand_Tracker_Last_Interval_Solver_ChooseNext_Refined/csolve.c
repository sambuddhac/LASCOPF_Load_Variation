...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
  ...
  mwSize dims[1];
  const char *var_names[] = {"Pg", "PgPrev", "Thetag"};
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "PgNext");
  if (xm == NULL) {
    printf("could not find params.PgNext.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("PgNext must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter PgNext must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter PgNext must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter PgNext must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.PgNext;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "PgNuInner");
  if (xm == NULL) {
    printf("could not find params.PgNuInner.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("PgNuInner must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter PgNuInner must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter PgNuInner must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter PgNuInner must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.PgNuInner;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "PgPrevNu");
  if (xm == NULL) {
    printf("could not find params.PgPrevNu.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("PgPrevNu must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter PgPrevNu must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter PgPrevNu must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter PgPrevNu must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.PgPrevNu;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "betaInner");
  if (xm == NULL) {
    printf("could not find params.betaInner.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("betaInner must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter betaInner must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter betaInner must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter betaInner must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.betaInner;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "lambda_3");
  if (xm == NULL) {
    printf("could not find params.lambda_3.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("lambda_3 must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter lambda_3 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter lambda_3 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter lambda_3 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.lambda_3;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "lambda_4");
  if (xm == NULL) {
    printf("could not find params.lambda_4.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("lambda_4 must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter lambda_4 must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter lambda_4 must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter lambda_4 must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.lambda_4;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  this_var_errors = 0;
  xm = mxGetField(prhs[0], 0, "selectZero");
  if (xm == NULL) {
    printf("could not find params.selectZero.\n");
  } else {
    if (!((mxGetM(xm) == 1) && (mxGetN(xm) == 1))) {
      printf("selectZero must be size (1,1), not (%d,%d).\n", mxGetM(xm), mxGetN(xm));
      this_var_errors++;
    }
    if (mxIsComplex(xm)) {
      printf("parameter selectZero must be real.\n");
      this_var_errors++;
    }
    if (!mxIsClass(xm, "double")) {
      printf("parameter selectZero must be a full matrix of doubles.\n");
      this_var_errors++;
    }
    if (mxIsSparse(xm)) {
      printf("parameter selectZero must be a full matrix.\n");
      this_var_errors++;
    }
    if (this_var_errors == 0) {
      dest = params.selectZero;
      src = mxGetPr(xm);
      for (i = 0; i < 1; i++)
        *dest++ = *src++;
      valid_vars++;
  ...
  if (prepare_for_c) {
    ...
    for (i = 0; i < 1; i++)
      printf("  params.PgPrevNu[%d] = %.6g;\n", i, params.PgPrevNu[i]);
    for (i = 0; i < 1; i++)
      printf("  params.PgNu[%d] = %.6g;\n", i, params.PgNu[i]);
    for (i = 0; i < 1; i++)
      printf("  params.betaInner[%d] = %.6g;\n", i, params.betaInner[i]);
    for (i = 0; i < 1; i++)
      printf("  params.PgNuInner[%d] = %.6g;\n", i, params.PgNuInner[i]);
    for (i = 0; i < 1; i++)
    ...
    for (i = 0; i < 1; i++)
      printf("  params.lambda_3[%d] = %.6g;\n", i, params.lambda_3[i]);
    for (i = 0; i < 1; i++)
      printf("  params.lambda_4[%d] = %.6g;\n", i, params.lambda_4[i]);
    for (i = 0; i < 1; i++)
    ...
    for (i = 0; i < 1; i++)
      printf("  params.selectZero[%d] = %.6g;\n", i, params.selectZero[i]);
    for (i = 0; i < 1; i++)
      printf("  params.PgNext[%d] = %.6g;\n", i, params.PgNext[i]);
    for (i = 0; i < 1; i++)
