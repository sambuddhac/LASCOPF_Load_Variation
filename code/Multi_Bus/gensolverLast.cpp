...
#define NUMTESTS 0
void GensolverLast::mainsolve(int APPItCount, double gsRho, double Pgprev[], double Pgavrg[], double Pprice[], double Apriceavg[], double Aavg[], double Aprice[], double PgenPrevAPP, double PgenAPP, double AAPP, double BAPP, double LambAPP3, double LambAPP4) {
  int num_iters;
#if (NUMTESTS > 0)
  int i;
  double time;
...
double GensolverLast::getPNextSol(void) {
 Piterate = (vars.Pg);
 return *Piterate;
}
...
double GensolverLast::getRMax()
{
	return params.RgMax[0];
} // end of getMax

double GensolverLast::getRMin()
{
	return params.RgMin[0];
} // end of getPMin

double GensolverLast::getPMax()
{
	return params.PgMax[0];
} // end of getMax

double GensolverLast::getPMin()
{
	return params.PgMin[0];
} // end of getPMin

double GensolverLast::getQuadCoeff()
{
	return params.c2[0]; 
} // end of getQuadCoeff

double GensolverLast::getLinCoeff()
{
	return params.c1[0]; 
} // end of getLinCoeff

double GensolverLast::getConstCoeff()
{
	return params.c0[0]; 
