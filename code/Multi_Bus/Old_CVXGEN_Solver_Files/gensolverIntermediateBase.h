...
#ifndef GENSOLVERINTERMEDIATEBASE_H
#define GENSOLVERINTERMEDIATEBASE_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverInterBase( int, double, double, double, double, double,  double, double, double, double, double ); // Gensolver object constructor
~GensolverInterBase(); // Gensolver object destructor
...
void mainsolve(int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double [], double []);
void load_default_data(int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double, double [], double []);
double getPSol(void);
