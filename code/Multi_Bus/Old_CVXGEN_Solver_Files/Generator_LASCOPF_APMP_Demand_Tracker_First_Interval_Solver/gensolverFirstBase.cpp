//solver.cpp
/* Produced by CVXGEN, 2019-01-02 21:12:05 -0500.  */
...
double GensolverFirstBase::eval_objv(void) {
  ...
  objv += params.c0[0]+work.quad_608032620544[0]+work.quad_643747205120[0]+work.quad_155015135232[0]+work.quad_497818112000[0];
  return objv;
}
...
/* Description: Basic test harness for solver.c. */
GensolverFirstBase::GensolverFirstBase( int numberOfCases, double cost2, double cost1, double cost0, double PgenMax, double PgenMin, double RgenMax, double RgenMin, double Beta, double Gamma, double innerGamma, double PgenPrevious ) {
...
#define NUMTESTS 0
void GensolverFirstBase::mainsolve(int outerAPPIt, int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double PgenNextAPP, double BAPP, double DAPP, double LambAPP1, double LambAPP2, double BSC[], double lambdaSC[]) {
  int num_iters;
#if (NUMTESTS > 0)
  int i;
  double time;
  ...
  set_defaults();
  setup_indexing();
  load_default_data(outerAPPIt, APPItCount, gsRho, Pgenprev, Pgenavg, Powerprice, Angpriceavg, Angavg, Angprice, PgenAPP, PgenNextAPP, BAPP, DAPP, LambAPP1, LambAPP2, BSC, lambdaSC);
...
void GensolverFirstBase::load_default_data(int outerAPPIt, int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double PgenNextAPP, double BAPP, double DAPP, double LambAPP1, double LambAPP2, double BSC[], double lambdaSC[]) {
  if (outerAPPIt==1) {
   if (APPItCount==1) {
    params.rho[0] = gsRho;
    params.PgNu[0] = 0.0;
