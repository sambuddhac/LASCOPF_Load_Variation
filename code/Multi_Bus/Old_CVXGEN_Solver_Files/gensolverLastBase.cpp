// solver.cpp
/* Produced by CVXGEN, 2019-01-20 18:40:31 -0500.  */
...
void GensolverLastBase::GensolverLastBase::fillrhs_aff(void) {
  int i;
  double *r1, *r2, *r3, *r4;
  r1 = work.rhs;
  r2 = work.rhs + 3;
...
//matrix_support.cpp
/* Produced by CVXGEN, 2019-01-20 18:40:29 -0500.  */
/* CVXGEN is Copyright (C) 2006-2017 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2017 Jacob Mattingley. */
/* CVXGEN, or solvers produced by CVXGEN, cannot be used for commercial */
/* applications without prior written permission from Jacob Mattingley. */
...
/* Description: Basic test harness for solver.c. */
GensolverLastBase::GensolverLastBase( int numberOfCases, double cost2, double cost1, double cost0, double PgenMax, double PgenMin, double RgenMax, double RgenMin, double Beta, double Gamma, double innerGamma, int nextPChoice ) {
