...
#ifndef GENSOLVERLASTBASE_H
#define GENSOLVERLASTBASE_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverLastBase( int, double, double, double, double, double,  double, double, double, double, double, int ); // Gensolver object constructor
~GensolverLastBase(); // Gensolver object destructor
...
void mainsolve(int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, double [], double []);
void load_default_data(int, int, double, double, double, double, double, double, double, double, double, double, double, double, double, double [], double []);
double getPSol(void);
