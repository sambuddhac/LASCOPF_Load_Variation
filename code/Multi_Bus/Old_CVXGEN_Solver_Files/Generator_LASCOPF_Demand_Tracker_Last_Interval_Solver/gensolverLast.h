...
#ifndef GENSOLVERLAST_H
#define GENSOLVERLAST_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverLast( int, double, double, double, double, double,  double, double, double, double ); // Gensolver object constructor
~GensolverLast(); // Gensolver object destructor
