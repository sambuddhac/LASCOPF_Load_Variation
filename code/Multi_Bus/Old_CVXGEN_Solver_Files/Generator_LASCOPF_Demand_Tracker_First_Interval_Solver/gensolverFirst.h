...
#ifndef GENSOLVERFIRST_H
#define GENSOLVERFIRST_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverFirst( int, double, double, double, double, double, double, double, double, double, double  ); // Gensolver object constructor
~GensolverFirst(); // Gensolver object destructor
