// solver.cpp
/* Produced by CVXGEN, 2019-01-02 21:59:46 -0500.  */
...
//matrix_support.cpp
/* Produced by CVXGEN, 2019-01-02 21:59:45 -0500.  */
/* CVXGEN is Copyright (C) 2006-2017 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2017 Jacob Mattingley. */
/* CVXGEN, or solvers produced by CVXGEN, cannot be used for commercial */
/* applications without prior written permission from Jacob Mattingley. */
...
/* Description: Basic test harness for solver.c. */
GensolverLastBase::GensolverLastBase( int numberOfCases, double cost2, double cost1, double cost0, double PgenMax, double PgenMin, double RgenMax, double RgenMin, double Beta, double Gamma, double innerGamma ) {
...
#define NUMTESTS 0
void GensolverLastBase::mainsolve(int outerAPPIt, int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double PgenPrevAPP, double AAPP, double BAPP, double LambAPP3, double LambAPP4, double BSC[], double lambdaSC[]) {
  int num_iters;
#if (NUMTESTS > 0)
  int i;
  double time;
  ...
  set_defaults();
  setup_indexing();
  load_default_data(outerAPPIt, APPItCount, gsRho, Pgenprev, Pgenavg, Powerprice, Angpriceavg, Angavg, Angprice, PgenAPP, PgenPrevAPP, AAPP, BAPP, LambAPP3, LambAPP4, BSC, lambdaSC);
...
void GensolverLastBase::load_default_data(int outerAPPIt, int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double PgenPrevAPP, double AAPP, double BAPP, double LambAPP3, double LambAPP4, double BSC[], double lambdaSC[]) {
  if (outerAPPIt==1) {
   if (APPItCount==1) {
    params.rho[0] = gsRho;
    params.PgNu[0] = 0.0;
