// solver.cpp
/* Produced by CVXGEN, 2019-01-02 21:48:52 -0500.  */
...
double GensolverInterBase::eval_objv(void) {
  ...
  objv += params.c0[0]+work.quad_399913824256[0]+work.quad_608032620544[0]+work.quad_643747205120[0]+work.quad_155015135232[0]+work.quad_497818112000[0];
  return objv;
}
...
// matrix_support.cpp
/* Produced by CVXGEN, 2019-01-02 21:48:49 -0500.  */
/* CVXGEN is Copyright (C) 2006-2017 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2017 Jacob Mattingley. */
/* CVXGEN, or solvers produced by CVXGEN, cannot be used for commercial */
/* applications without prior written permission from Jacob Mattingley. */
...
void GensolverInterBase::fill_KKT(void) {
  work.KKT[24] = 2*(params.c2[0]+work.frac_479733190656+work.frac_121674190848);
...
/* Description: Basic test harness for solver.c. */
GensolverInterBase::GensolverInterBase( int numberOfCases, double cost2, double cost1, double cost0, double PgenMax, double PgenMin, double RgenMax, double RgenMin, double Beta, double Gamma, double innerGamma ) {
...
#define NUMTESTS 0
void GensolverInterBase::mainsolve(int outerAPPIt, int APPItCount, double gsRho, double Pgenprev, double Pgenavg, double Powerprice, double Angpriceavg, double Angavg, double Angprice, double PgenAPP, double PgenNextAPP, double PgenPrevAPP, double AAPP, double BAPP, double DAPP, double LambAPP1, double LambAPP2, double LambAPP3, double LambAPP4, double BSC[], double lambdaSC[]) {
  int num_iters;
#if (NUMTESTS > 0)
  int i;
  double time;
  ...
  set_defaults();
  setup_indexing();
  load_default_data(outerAPPIt, APPItCount, gsRho, Pgenprev, Pgenavg, Powerprice, Angpriceavg, Angavg, Angprice, PgenAPP, PgenNextAPP, PgenPrevAPP, AAPP, BAPP, DAPP, LambAPP1, LambAPP2, LambAPP3, LambAPP4, BSC, lambdaSC);
